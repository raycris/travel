...
import SanFranDesk from "../assets/images/sanFranciscoDesktop.jpg";

const Home = ({ id }) => {
  return (
    <div className="w-full h-3/4" id={id}>
      <div className="w-full h-full">
        ...
        <div className="w-full h-full lg:h-full lg:bg-sanFranciscoDesktop lg:bg-cover lg:bg-center">
          ...
          <img
            className="hidden w-full lg:flex lg:h-full lg:bg-cover lg:bg-center"
            src={SanFranDesk}
            alt="San Francisco"
          />
        </div>
