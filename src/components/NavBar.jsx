...
const NavBar = () => {
  return (
    <nav className="w-full h-14 hidden bg-white lg:flex p-4 justify-between fixed ">
      <div className="h-auto w-auto">
        <p className="text-xl text-primary font-black">Travel Word</p>
      </div>
      ...
      <div className="flex space-x-8">
        ...
        <a className="font-bold text-md text-primary" href="#popular_rents">
          Rents
        </a>
        <a className="font-bold text-md text-primary" href="#faq">
          FAQ
        </a>
        <a className="font-bold text-md text-primary" href="#footer">
          About us
        </a>
      </div>
      ...
      <div className="flex space-x-4">
        ...
        >
          <path
            className="fill-current text-principal text-primary cursor-pointer"
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        >
          <path
            className="fill-current text-gray-300 cursor-pointer"
            fillRule="evenodd"
            clipRule="evenodd"
