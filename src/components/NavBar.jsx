  ...
  return (
    <nav className="w-full h-14 hidden bg-white lg:flex p-4 justify-between fixed z-10 dark:bg-gray-800">
      <div className="h-auto w-auto">
        <p className="text-xl text-primary font-black dark:text-white">Travel Word</p>
      </div>

      <div className="flex space-x-8">
        <a className="font-bold text-md text-primary dark:text-white" href="#home">
          Home
        </a>
        <a className="font-bold text-md text-primary dark:text-white" href="#recommended">
          Recommended
        </a>
        <a className="font-bold text-md text-primary dark:text-white" href="#popular_rents">
          Rents
        </a>
        <a className="font-bold text-md text-primary dark:text-white" href="#faq">
          FAQ
        </a>
        <a className="font-bold text-md text-primary dark:text-white" href="#footer">
          About us
        </a>
      </div>
