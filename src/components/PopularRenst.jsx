  ...
  return (
    <div className="px-2 h-auto w-full" id={id}>
      ...
      <div className="w-full h-auto flex flex-col space-y-6 items-center justify-center">
        <div className="w-full h-96 bg-tertiary  bg-cover rounded-lg">
          <picture>
            <img className=" rounded-lg" src={Chicago} alt="Chicago"  />
          </picture>
          <p className="CardTitle bg-tertiary">Chicago</p>
          <p className="text-sm pl-8 text-black mr-24">2 rooms, 1 bathroom, 1 kitchen</p>
        </div>
        <div className="w-full h-96 bg-tertiary  bg-cover rounded-lg">
          <picture>
            <img className="rounded-xl" src={Chicago} alt="Chicago"  />
          </picture>
